...
object FragmentUtils {
     ...
     */
    fun replaceFragment(activity: AppCompatActivity, fragment: Fragment, id: Int, addToBackStack: Boolean, animationType: FragmentAnimation) {
        val fragmentManager = activity.getSupportFragmentManager()
        val transaction = fragmentManager.beginTransaction()
        ...
        when (animationType) {
            ...
            FragmentAnimation.TRANSITION_SLIDE_LEFT_RIGHT -> transaction.setCustomAnimations(R.anim.slide_in_from_rigth, R.anim.slide_out_to_left, R.anim.slide_in_from_left, R.anim.slide_out_to_right)
     ...
     * @param animationType: Fragment transition animation type
     */
    fun replaceFragmentAllowingStateLoss(activity: AppCompatActivity, fragment: Fragment, id: Int, addToBackStack: Boolean, animationType: FragmentAnimation) {
    ...
    fun isCurrentTopFragment(activity: AppCompatActivity, fragmentTag: String): Boolean {
        val fragmentManager = activity.getSupportFragmentManager()
        val tag = fragmentManager.getBackStackEntryAt(fragmentManager.getBackStackEntryCount() - 1).getName()
